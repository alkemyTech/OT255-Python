SELECT
	replace(uk.universidades, '-', ' ') as university,
	replace(uk.carreras, '-', ' ') as career,
...
<<<<<<< HEAD
<<<<<<< HEAD
	cast(uk.codigos_postales as int) as postal_code,
...
=======
	...
	uk.emails as email
FROM uba_kenedy uk LEFT JOIN localidad as l1 on cast(uk.codigos_postales as int) = l1.codigo_postal -- join localidad to get locations
>>>>>>> 588476a (UC-UBA change file names)
=======
	cast(uk.codigos_postales as int) as postal_code,
--	l1.codigo_postal as postal_code,
--	l1.localidad as location,
	uk.emails as email
FROM uba_kenedy uk -- LEFT JOIN localidad as l1 on cast(uk.codigos_postales as int) = l1.codigo_postal -- join localidad to get locations
>>>>>>> ce446db (UC-UBA edit query output (delete join with locations))
