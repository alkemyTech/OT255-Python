SELECT
	...
	array_agg (l1.codigo_postal) as postal_code,
	l1.localidad as location,
	lsc1.emails as email
FROM lat_sociales_cine lsc1 LEFT JOIN localidad l1 on REPLACE(lsc1.locations, '-', ' ') = l1.localidad
