...
transformar_datos_univ_palermo = PythonOperator(
    ...
    python_callable = transformar_datos_univ_palermo,
    dag=dag
)

cargar_datos_univ_palermo = PythonOperator(
    task_id = "cargar_datos",
    python_callable = cargar_datos_univ_palermo,
    dag=dag
)

extraer_datos_univ_palermo << transformar_datos_univ_palermo << cargar_datos_univ_palermo